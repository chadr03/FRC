...
public class RobotMap {
   //Robot Constants
	public static double WHEEL_DIA=6.0;
	public static int ENCODER_CLICK_PER_REV=4096;
    ...
    public static double kPdriveGyro = 0.1;
    
    public static double kPdriveDistance = 3.0e-4;
    public static double kIdriveDistance = 0;
    public static double kDdriveDistance = 0.001;
    
    public static double kPturn = 0.019;
    public static double kIturn = 0;
    public static double kDturn = 0.035;
    
    //pixyturn
    public static double kPpixy = 1.7;
    public static double kIpixy = 0;
    public static double kDpixy = 1.5;
